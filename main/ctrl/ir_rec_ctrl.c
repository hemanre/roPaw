...
#include "misc/ir_rec_encoder.h"
#include "gpios.h"
#include "drivers/motor_drvr.h"

#define EXAMPLE_IR_RESOLUTION_HZ     1000000 // 1MHz resolution, 1 tick = 1us
#define EXAMPLE_IR_TX_GPIO_NUM       19
...
#define normal_frame 34
#define repeat_frame 2

static const char *TAG = "ir_drvr";
...
//    printf("---NEC frame end: ");
    // decode RMT symbols
    switch (symbol_num) {
    case normal_frame: // NEC normal frame
        if (nec_parse_frame(rmt_nec_symbols)) {
            printf("Address=%04X, Command=%04X\r\n\r\n", s_nec_code_address, s_nec_code_command);
            for(int cmd_index=0; cmd_index<ir_cmd_total; cmd_index++){
            	if(ir_cmd[cmd_index]==s_nec_code_command){
            		switch (cmd_index){
        ...
        break;
    case repeat_frame: // NEC repeat frame
...
void ir_drvr_cmd_str_init(){
//	ir_cmd[ir_cmd_0] 		= 0xAD52;
//	ir_cmd[ir_cmd_1] 		= 0xE916;
//	ir_cmd[ir_cmd_2] 		= 0xE619;
//	ir_cmd[ir_cmd_3] 		= 0xF20D;
//	ir_cmd[ir_cmd_4] 		= 0xF30C;
//	ir_cmd[ir_cmd_5] 		= 0xE718;
//	ir_cmd[ir_cmd_6] 		= 0xA15E;
//	ir_cmd[ir_cmd_7] 		= 0xF708;
//	ir_cmd[ir_cmd_8] 		= 0xE31C;
//	ir_cmd[ir_cmd_9] 		= 0xA55A;
//	ir_cmd[ir_cmd_asterix]  = 0xBD42;
//	ir_cmd[ir_cmd_hash] 	= 0xB54A;
//	ir_cmd[ir_cmd_ok] 		= 0xBF40;
//	ir_cmd[ir_cmd_up] 		= 0xB946;
//	ir_cmd[ir_cmd_down] 	= 0xEA15;
//	ir_cmd[ir_cmd_left] 	= 0xBB44;
//	ir_cmd[ir_cmd_right] 	= 0xBC43;

	ir_cmd[ir_cmd_aclk_fwd] = 0xF30C;
	...
	ir_cmd[ir_cmd_clk_bwd]  = 0xE916;
}

void ir_rec_drvr_init(void)
{
	ir_drvr_cmd_str_init();
